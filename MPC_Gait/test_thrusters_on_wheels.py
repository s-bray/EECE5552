...
This script demonstrates thruster control on a quadruped with wheeled feet.
Perfect for testing thruster logic with the wheels.

Usage:
    python3 test_thrusters_on_wheels.py
"""
...
def test_thrusters():
    ...
    data.qpos[0:3] = [0, 0, 0.9]  # x, y, z position
    ...
    with mujoco.viewer.launch_passive(model, data) as viewer:
        ...
        while viewer.is_running():
            ...
            # PID Gains (Increased for heavier robot)
            kp_roll = 800.0
            kd_roll = 50.0
